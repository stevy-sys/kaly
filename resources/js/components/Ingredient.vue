<template>
  <div>
    <div class="text-center mb-3">
      <button @click="plus()" class="btn btn-primary pl-3 pr-3" type="button">
        +
      </button>
      <button @click="moins()" class="btn btn-danger pl-3 pr-3" type="button">
        -
      </button>
    </div>
    <div v-for="i in initial" :key="i" class="row recette">
